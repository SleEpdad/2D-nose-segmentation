...
最后，将图像分割成训练图像和标签。
    ...
    def __init__(self, train_path="data/train/image", label_path="data/train/label",
                 merge_path="data/train/merge", aug_merge_path="data/aug_merge",
                 aug_train_path="/media/zhangyuwei/本地磁盘/data/aug_train", aug_label_path="/media/zhangyuwei/本地磁盘/data/aug_label",
                 img_type="jpg"):
...
class dataProcess(object):
    ...
    def __init__(self, out_rows, out_cols,  aug_merge_path="data/aug_merge",
                 aug_train_path="/media/zhangyuwei/本地磁盘/data/aug_train", aug_label_path="/media/zhangyuwei/本地磁盘/data/aug_label", test_path = 'data/test', npy_path="/media/zhangyuwei/本地磁盘/npydata",
                 img_type="jpg"):
    ...
    def create_train_data(self):
        ...
        for i in range(count):
          img=load_img('/media/zhangyuwei/本地磁盘/data/aug_train/'+str(i)+'.jpg',grayscale=True)
          label=load_img('/media/zhangyuwei/本地磁盘/data/aug_label/'+str(i)+'.jpg',grayscale=True)
    ...
    def create_test_data(self,m,n,q):
        ...
        imgdatas = np.ndarray((m*n,q,q, 1), dtype=np.uint8)
        k = 0
        for i in range(m):
            for j in range(n):
                dst = load_img('/home/zhangyuwei/桌面/unet/data/test/' + str(k) + '.jpg', grayscale=True)
                img = img_to_array(dst)
                imgdatas[k] = img
                k+=1
        np.save('/media/zhangyuwei/本地磁盘/npydata/imgs_test.npy', imgdatas)
...
if __name__ == "__main__":
    ...
    # mydata.create_test_data(20,10,120)
